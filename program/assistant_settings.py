...
async def join_chat(c: Client, m: Message):
    ...
    try:
        ...
        return await user.send_message(chat_id, "✅ تم الانضمام بنجاح")
...
async def leave_chat(c :Client, m: Message):
    ...
    try:
        if chat_id in QUEUE:
            ...
            await user.leave_chat(chat_id)
            return await c.send_message(chat_id, "✅ تم المغادره بنجاح")
...
async def start_group_call(c: Client, m: Message):
    chat_id = m.chat.id
    msg = await c.send_message(chat_id, "`❤️‍🔥جاري فتح محادثه مرئيه...`")
    try:
        ...
        await msg.edit_text("✅ تم بنجاح فتح المحادثه المرئيه !")
...
async def stop_group_call(c: Client, m: Message):
    chat_id = m.chat.id
    msg = await c.send_message(chat_id, "`✅ جاري اغلاق المحادثه...`")
    try:
        if not (
            group_call := (
